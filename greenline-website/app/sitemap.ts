...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  return [
    ...
    // Florida hub + city pages
    { url: `${BASE}/florida/brand-activation/`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${BASE}/florida/miami/brand-activation-staff/`, lastModified: now, changeFrequency: "monthly", priority: 0.7 },
    { url: `${BASE}/florida/tampa/brand-activation-staff/`, lastModified: now, changeFrequency: "monthly", priority: 0.7 },
    { url: `${BASE}/florida/orlando/brand-activation-staff/`, lastModified: now, changeFrequency: "monthly", priority: 0.7 },
    { url: `${BASE}/florida/jacksonville/brand-activation-staff/`, lastModified: now, changeFrequency: "monthly", priority: 0.7 },
    { url: `${BASE}/florida/fort-lauderdale/brand-activation-staff/`, lastModified: now, changeFrequency: "monthly", priority: 0.7 },
    // Booking & results
    ...
    ...blogEntries,
    { url: `${BASE}/pilot-program/`, lastModified: now, changeFrequency: "monthly", priority: 0.7 },
    { url: `${BASE}/retail-activation-roi-calculator/`, lastModified: now, changeFrequency: "monthly", priority: 0.7 },
    { url: `${BASE}/schedule-an-intro-call/`, lastModified: now, changeFrequency: "monthly", priority: 0.7 },
    { url: `${BASE}/ambassador-rewards-program/`, lastModified: now, changeFrequency: "monthly", priority: 0.6 },
    { url: `${BASE}/brand-ambassador-opportunities/`, lastModified: now, changeFrequency: "monthly", priority: 0.6 },
    { url: `${BASE}/brand-ambassador-application/`, lastModified: now, changeFrequency: "monthly", priority: 0.5 },

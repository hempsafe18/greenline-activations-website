      ...
      <div className="container-lg max-w-3xl">
        ...
        <div className="space-y-10">
          ...
          <Block title="14. Payment Terms">
            <p><strong>50% Deposit Required at Booking.</strong> All activation sprint purchases require a 50% deposit at the time of booking, collected via Stripe. The remaining balance is due net 7 from the final activation in the sprint, or per the schedule communicated during onboarding.</p>
